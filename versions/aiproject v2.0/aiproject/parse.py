...
def askai(question):
    if 'diagram' in question or 'image' in question or 'study' in question and 'studying' not in question:
        try:
            print('---\nImage Question\n---')
            image = parseimage()
            model = vision()
